...
static OPENAI_INJECTION: InjectionSpec = InjectionSpec {
    endpoint_env: "OPENAI_BASE_URL",
    api_key_env: "OPENAI_API_KEY",
    proxy_envs: &["HTTP_PROXY", "HTTPS_PROXY", "NO_PROXY"],
    strip_envs: &["OPENAI_API_KEY", "ANTHROPIC_API_KEY"],
    endpoint_strip_v1: false,
};

static GOOGLE_INJECTION: InjectionSpec = InjectionSpec {
    endpoint_env: "GOOGLE_API_ENDPOINT",
    api_key_env: "GOOGLE_API_KEY",
    proxy_envs: &["HTTP_PROXY", "HTTPS_PROXY", "NO_PROXY"],
    strip_envs: &["GOOGLE_API_KEY", "GEMINI_API_KEY"],
    endpoint_strip_v1: false,
};
...
pub static RUNTIMES: &[RuntimeSpec] = &[
    ...
    RuntimeSpec {
        name: "GitHub Copilot",
        binary_names: &["github-copilot", "copilot"],
        version_arg: "--version",
        config_locator: ConfigLocator::EnvOrHome {
            env_var: "",
